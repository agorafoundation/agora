(function() {
	...
	function showSuccess($, id_token, signedInIdToken){
		...
		$.ajax({
			...
			data: JSON.stringify(
				{
					"orcidId": signedInIdToken.iss + "/" + signedInIdToken.sub,
					"orcidGivenName": signedInIdToken.given_name,
					"orcidFamilyName": signedInIdToken.family_name,
					"orcidIdToken": id_token
				}
			),
			contentType: "application/json; charset=utf-8"})
			.done((data) => {window.location = data.redirect});
