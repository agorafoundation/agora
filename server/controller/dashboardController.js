...
exports.getSharedDashboard = async function( req, res ) {
    ...
    if( workspace.ownedBy === req.session.authUser.userId ) {
        res.render( 'shared-dashboard/shared-dashboard', { ownerWorkspaces: ownerWorkspaces, workspace: workspace, ownerTopics: ownerTopics, topic: topic, availableTopics: availableTopics, availableResources: availableResources, resource: resource, messageType: messageType, messageTitle: messageTitle, messageBody: messageBody } );
    }
    else {
        ...
        res.render( 'shared-dashboard/shared-dashboard', { ownerWorkspaces: ownerWorkspaces, workspace: null, ownerTopics: ownerTopics, topic: topic, messageType: messageType, messageTitle: messageTitle, messageBody: messageBody } );
    }
